...
NAMES = ['WT_140416(1)','WT_140416(2)','WT_250516(1)','WT_310516(1)',
         'WT_070616(1)','WT_070616(2)','WT_080616(1)','WT_080616(2)',
         'WT_090616(1)','WT_090616(2)','WT_161116(1)','WT_171116(1)',
         'WT_181116(1)','WT_181116(2)']


FOLDERS = ['AD-14-04-2016','AD-14-04-2016','AD-25-05-2016','AD-31-05-2016',
           'AD-07-06-2016','AD-07-06-2016','AD-08-06-2016','AD-08-06-2016',
           'AD-09-06-2016','AD-09-06-2016','AD-16-11-2016','AD-17-11-2016',
...
savedir = 'U:/01_ANALYSIS/01_BRAVE_NEW_WORLD/CHARGE_ANALYSIS/00_MAPS/WT'

#Excel sheet with zebrin band measures : Mesures_ZII_HighRes_WT_Cuff_Sham_Enr.xlsx
df  = pd.read_excel(r"U:\01_ANALYSIS\01_BRAVE_NEW_WORLD\Mesures_ZII_HighRes_WT_Cuff_Sham_Enr.xlsx",
...
filelist  = pd.read_excel(r"U:\01_ANALYSIS\01_BRAVE_NEW_WORLD\GC-PC_mappings_data_info.xlsx",
